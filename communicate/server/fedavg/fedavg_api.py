...
def init_server(clients, train_loader, test_loader, args, device, model_trainer, eval_loader=None):
    model_trainer.set_data(train_loader, eval_loader, test_loader)
